...
import FormUser from "./components/FormUser";
      ...
      export default function FormsUser(){
            return(
                  <section className=" min-h-dvh w-full bg-register ">
                        <section className=" flex flex-col items-center min-h-dvh w-full py-6 bg-backgroundRegister/70 ">
                              <Logo />
                              <section className=" min-h-18 ">
                              <h2 className=" pt-3 text-3xl md:text-5xl font-extrabold text-colorAccent ">TalentFlow</h2>
                              </section>
                              <section className=" w-10/12 max-w-140 py-2 px-10 md:px-12   border border-borderBtn/30 rounded-xl ">
