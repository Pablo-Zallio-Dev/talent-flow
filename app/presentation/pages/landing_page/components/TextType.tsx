...
import { ElementType, useEffect, useRef, useState, createElement, useMemo, useCallback, forwardRef, useImperativeHandle } from 'react';
...
const TextType = forwardRef<HTMLElement, TextTypeProps & React.HTMLAttributes<HTMLElement>>(({
  ...
  useEffect(() => {
    if (!startOnVisible || !internalRef.current) return;
  ...
  return createElement(
    ...
    <span className="inline font-semibold text-3xl " style={{ color: getCurrentTextColor() }}>
      {displayedText}
    </span>,
    showCursor && (
