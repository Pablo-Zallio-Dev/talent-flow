...
export default function ItemFunctionHome( {numberItem, title, text}: ItemFunctionHomeProps ){
      return(
            <section className=" flex flex-col items-center gap-8 py-5 px-9 w-80 shadow-md/25 shadow-foreground md:hover:shadow-lg/40 md:hover:-translate-y-5 transition-all duration-150 rounded-lg ">
